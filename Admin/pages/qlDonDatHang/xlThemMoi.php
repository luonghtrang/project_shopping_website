<?php
    ...
    if(isset($_POST['cmbMaSanPham']))
    {
        ...
        if($maDonDatHang == '0')
        {
            ...
            $sql =  "INSERT INTO chitietdondathang(MaChiTietDonDatHang, SoLuong, GiaBan, MaDonDatHang, MaSanPham) VALUES ('$maChiTietDonDatHang', '$soLuong', '$giaSanPham', '$maDonDatHang', '$maSanPham')";
