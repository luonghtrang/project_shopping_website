    ...
    <form action="./pages/qlTaiKhoanNguoiDung/xlCapNhat.php" method="POST" onsubmit="return KiemTra()" enctype="multipart/form-data" class="frm">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="txtTenDangNhap" class="form-control" id="txtTenDangNhap" value="<?php echo $row['TenDangNhap'] ?>" readonly="true">
                <i id="errTenDangNhap" class="text-danger"></i>
            </div>
            <div class="form-group">
                <label for="pass01">Mật khẩu cũ</label>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="cmbLoaiTaiKhoan" name="cmbLoaiTaiKhoan">
                ...
                while ($row_2 = mysqli_fetch_array($result)) {
                    ...
                    if($row_2['MaLoaiTaiKhoan'] == $row['MaLoaiTaiKhoan'])
                    {
                        $selected = "selected";
                    }
                    else
                    ...
                    <option value="<?php echo $row_2['MaLoaiTaiKhoan']; ?>" <?php echo $selected ?>><?php echo $row_2['TenLoaiTaiKhoan']; ?></option>
...
<script type="text/javascript">
    function KiemTra()
    {
        ...
        {
            err.innerHTML = "Password cũ không đúng";
            ten.focus();
            return false;
        }
        else
