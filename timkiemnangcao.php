            ...
            <form id='formTimKiemNangCao' action='javascript:void(0)' method='GET'>
              ...
              <div class='form-row'>
                ...
                <div class='form-group col-md-3'>
                  ...
                  <input class='form-control' id='giaBatDau' type='number' placeholder='100' value='1' min='0'>
                </div>
                <div class='form-group col-md-3'>
                  <label for='loaiSanPham'>Giá kết thúc</label>
                  <input class='form-control' id='giaKetThuc' type='number' min='0' value='1000000' placeholder='100000'>
                </div>
              </div>
