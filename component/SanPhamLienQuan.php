...
$sql_1 = "SELECT * FROM sanpham WHERE BiXoa = 0 AND MaLoaiSanPham = $maLoaiSanPham  AND MaSanPham != $id  AND SoLuongTon > 0 LIMIT 0,5 ";
$result_1 =  DataProvider::ExecuteQuery($sql_1);
    ...
    $sanPhamLienQuan .= " <div class='item'>
                                <figure>
                                    <div class='img-box'>
                                        ...
                                        <a onclick='ThemHang(this)' data-maSanPham='$maSanPham_1' href='javascript:void(0)'>
                                    ...
                                    <figcaption>
                                        ...
                                        <div class='chi-tiet mt-2'>
                                            ...
                                            <a onclick='ThemHang(this)' data-maSanPham='$maSanPham_1' href='javascript:void(0)'>Thêm giỏ hàng
                                            </a>
                                        </div>
                                    </figcaption>
                                </figure>
