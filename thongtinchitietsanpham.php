          ...
          <div class='row'>
            ...
            <div class='col-md-7'>
              ...
              <div class='them-vao-gio'>
                ...
                <input id='soLuong' name='soluong' min='1' type='number' value='1' max='$soLuongTon'><a id='themGioHang' href='javascript:void(0)' class='$disable'><i class='fas fa-shopping-cart'></i>Thêm giỏ hàng</a>
              </div>
              <div class='text-danger' id='errAmount'></div>
              <hr>
              <div class='mo-ta'>
                <h5>Mô Tả</h5>
                <p>$moTa</p>
